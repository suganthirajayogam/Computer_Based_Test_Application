...
class _CreateAccountScreenState extends State<visionCreateAccountScreen> {
  ...
  Future<void> _loadModules() async {
    try {
      final fetchedModules = await Database_helper.instance.getVisionModules();
  ...
  void _submit() async {
    if (_formKey.currentState!.validate()) {
      ...
      final rowsAffected = await Database_helper.instance.updateModule(empId, selectedModule!);
